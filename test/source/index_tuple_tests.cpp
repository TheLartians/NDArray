...
TEST_CASE("Index tuple basics") {
  ...
  DynamicIndexTuple<4> dynamic_index_tuple =
      make_dynamic_index_tuple(4, 3, 2, 1);
  ...
  IndexTuple<StaticIndex<1>, DynamicIndex, StaticIndex<3>, DynamicIndex>
      mixed_index_tuple;
  ...
  // REQUIRE_THROWS(static_index_tuple = dynamic_index_tuple); only throws in
  // debug mode REQUIRE_THROWS(mixed_index_tuple = dynamic_index_tuple); only
  ...
  REQUIRE((dynamic_index_tuple + dynamic_index_tuple ==
           StaticIndexTuple<2, 4, 6, 8>()));
  REQUIRE((static_index_tuple + static_index_tuple ==
           StaticIndexTuple<2, 4, 6, 8>()));
  REQUIRE((dynamic_index_tuple + static_index_tuple ==
           StaticIndexTuple<2, 4, 6, 8>()));
  REQUIRE((dynamic_index_tuple * dynamic_index_tuple ==
           StaticIndexTuple<1, 4, 9, 16>()));
  REQUIRE((static_index_tuple * static_index_tuple ==
           StaticIndexTuple<1, 4, 9, 16>()));

  REQUIRE((decltype(static_index_tuple * static_index_tuple)() ==
           StaticIndexTuple<1, 4, 9, 16>()));

  static_assert(decltype(static_index_tuple * static_index_tuple)::get<2>() ==
                    9,
                "compile time evaluation");
  static_assert(decltype(static_index_tuple + static_index_tuple)::get<2>() ==
                    6,
                "compile time evaluation");
  static_assert(decltype(static_index_tuple * mixed_index_tuple)::get<2>() == 9,
                "compile time evaluation");
  static_assert(decltype(static_index_tuple + mixed_index_tuple)::get<2>() == 6,
                "compile time evaluation");
  ...
  static_assert(decltype(mixed_index_tuple.slice<0, 2>() *
                         static_index_tuple.slice<2, 4>())::get<0>() == 3,
                "compile time evaluation");
}
